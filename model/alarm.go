...
JSON Sample
-------------------------------------
{    "id": "LBGDCfrEjLYbskAZvOSuHWeQq",    "dn": "BVIhUcBZgCRPDcWrvPlnXHMJj",    "title": "dxvVEhlexxFDvNWgeXVaSYQhE",    "type": 85,    "description": "JQuZmDSXdlNCFMjXGsXIAVWuX",    "status": 29,    "level": 88,    "event_time": 22,    "create_at": 48,    "updated_at": 80,    "object_id": "xAabuDQIFlnwbOcIDhllyDagA",    "object_name": "CwZtngWLZYMYSolICRehcTrZQ",    "location": "bsHgByBDvXarFMNDXpKxJMgnk",    "total_count": 44,    "clear_time": 17,    "ack_flag": 81,    "archive_flag": 97,    "ack_time": 36,    "clear_user": "EmKSHrtrwjnxJqBdZjldqAJIU",    "ack_user": "MOJSBqPnVpourQdpfgeDxYggg",    "archive_time": 92,    "archive_user": "OwomkbfyUFIXlbfJMjBQrBMqd",    "extra_data": "ReFxKgUjAxPoOQMwpytPhsAYG"}
...
var (
	Alarm_FIELD_NAME_id = "id"

	Alarm_FIELD_NAME_dn = "dn"

	Alarm_FIELD_NAME_title = "title"

	Alarm_FIELD_NAME_type = "type"

	Alarm_FIELD_NAME_description = "description"

	Alarm_FIELD_NAME_status = "status"

	Alarm_FIELD_NAME_level = "level"

	Alarm_FIELD_NAME_event_time = "event_time"

	Alarm_FIELD_NAME_create_at = "create_at"

	Alarm_FIELD_NAME_updated_at = "updated_at"

	Alarm_FIELD_NAME_object_id = "object_id"

	Alarm_FIELD_NAME_object_name = "object_name"

	Alarm_FIELD_NAME_location = "location"

	Alarm_FIELD_NAME_total_count = "total_count"

	Alarm_FIELD_NAME_clear_time = "clear_time"

	Alarm_FIELD_NAME_ack_flag = "ack_flag"

	Alarm_FIELD_NAME_archive_flag = "archive_flag"

	Alarm_FIELD_NAME_ack_time = "ack_time"

	Alarm_FIELD_NAME_clear_user = "clear_user"

	Alarm_FIELD_NAME_ack_user = "ack_user"

	Alarm_FIELD_NAME_archive_time = "archive_time"

	Alarm_FIELD_NAME_archive_user = "archive_user"

	Alarm_FIELD_NAME_extra_data = "extra_data"
)

// Alarm struct is a row record of the f_alarm table in the  database
type Alarm struct {
	ID          string           `json:"id"`           //id
	Dn          string           `json:"dn"`           //dn
	Title       string           `json:"title"`        //告警标题
	Type        int32            `json:"type"`         //告警类型:1:系统,2:通讯
	Description string           `json:"description"`  //告警描述
	Status      int32            `json:"status"`       //0:已清除告警,1:未清除告警
	Level       int32            `json:"level"`        //级别,1:严重,2:一般,3:警告,4:描述
...
var AlarmTableInfo = &TableInfo{
	...
	Columns: []*ColumnInfo{
		...
		&ColumnInfo{
			Index:              6,
			Name:               "level",
			Comment:            `级别,1:严重,2:一般,3:警告,4:描述`,
			Notes:              ``,
			Nullable:           false,
			DatabaseTypeName:   "INT2",
			DatabaseTypePretty: "INT2",
...
func (a *Alarm) BeforeSave() error {
	return nil
}

// Prepare invoked before saving, can be used to populate fields etc.
func (a *Alarm) Prepare() {
}

// Validate invoked before performing action, return an error if field is not populated.
func (a *Alarm) Validate(action Action) error {
	return nil
}

// TableInfo return table meta data
func (a *Alarm) TableInfo() *TableInfo {
	return AlarmTableInfo
}
